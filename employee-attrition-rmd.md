...
![](employee-attrition-rmd_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
![](employee-attrition-rmd_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](employee-attrition-rmd_files/figure-gfm/unnamed-chunk-13-2.png)<!-- -->
...
![](employee-attrition-rmd_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
![](employee-attrition-rmd_files/figure-gfm/unnamed-chunk-14-2.png)<!-- -->
...
```
    ...
    ## [13:21:08] WARNING: amalgamation/../src/learner.cc:1115: Starting in XGBoost 1.3.0, the default evaluation metric used with the objective 'binary:logistic' was changed from 'error' to 'logloss'. Explicitly set eval_metric if you'd like to restore the old behavior.
...
![](employee-attrition-rmd_files/figure-gfm/unnamed-chunk-20-1.png)<!-- -->
