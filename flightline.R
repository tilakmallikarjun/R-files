...
data1<-read.csv("flightline_2.csv", stringsAsFactors=FALSE)
# Display orphans
...
BOM_flightline <- ToDataFrameTree(finalassembly_data, "NEXT.ASSEMBLY", "COMPONENT","COMPONENT.new","parent_line","pathString" ,"level")

write.xlsx(BOM_flightline, "BOM_flightline.xlsx")
